...
export default function SignupPage() {
    ...
    const handlePasswordUpdate = (value: string) => {
        ...
        if (!value) {
            ...
            setErrors((prev) => ({
                ...prev,
                password: "Only letters, numbers, and !@#$%^&* allowed",
            }));
        } else {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-zinc-100 dark:bg-zinc-950 px-4 py-8">
            <div className="w-full max-w-md p-8 bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-lg">
                ...
                <form className="space-y-5" onSubmit={handleSubmit}>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className={`w-full px-4 py-3 pr-12 bg-zinc-50 dark:bg-zinc-800 border rounded-xl text-zinc-900 dark:text-white placeholder-zinc-400 focus:outline-none focus:ring-2 transition-all duration-200 ${showConfirmPasswordError ? "border-red-500 focus:ring-red-500" : isConfirmPasswordValid ? "border-green-500 focus:ring-green-500" : "border-zinc-200 dark:border-zinc-700 focus:ring-blue-500"}`}
                                placeholder="••••••••"
                            />
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className="w-full py-3 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 disabled:cursor-not-allowed hover:cursor-pointer text-white font-medium rounded-xl transition-all duration-200 flex items-center justify-center gap-2"
                    >
                        {isLoading ? (
                            <>
                ...
                <p className="text-center text-sm text-zinc-600 dark:text-zinc-400 mt-6">
                    ...
                    <Link
                        to="/login"
                        className="ml-1 text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-medium transition-all duration-200"
                    >
                        Sign in
                    </Link>
                </p>
