...
export default function NavBar() {
    ...
    return (
        <aside className="fixed bottom-0 left-0 right-0 md:top-0 md:bottom-0 md:right-auto flex md:flex-col border-t md:border-t-0 md:border-r border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 z-10">
            <Link
                to="/"
                className="hidden md:flex justify-center items-center gap-3 p-6 border-b border-zinc-200 dark:border-zinc-800"
            >
